...
public class BombExplode {
    ...
    public BombExplode(int x, int y, int size, ArrayList<Box> arrBox) {
        this.x = x;
        this.y = y;
        this.size = size;
        this.timeLine = 250;
    ...
    public void drawBombExplode(Graphics2D g2d) {
    ...
    public boolean isImpactBombExplodeVsBox(Box box) {
        if (box.getType() == Box.DISALLOW_EXPLODE) {
            return false;
        }
    ...
    public boolean isImpactBombExplodeVsItem(Item item) {
        Rectangle rec1 = new Rectangle(x + 45 - img_left.getWidth(null), y, img_left.getWidth(null), img_left.getHeight(null));
        Rectangle rec2 = new Rectangle(x, y, img_right.getWidth(null), img_right.getHeight(null));
        Rectangle rec3 = new Rectangle(x, y + 45 - img_up.getHeight(null), img_up.getWidth(null), img_up.getHeight(null));
        Rectangle rec4 = new Rectangle(x, y, img_down.getWidth(null), img_down.getHeight(null));
    ...
    public boolean isImpactBombExplodeVsBomb(Bomb bomb) {
        Rectangle rec1 = new Rectangle(x + 45 - img_left.getWidth(null), y, img_left.getWidth(null), img_left.getHeight(null));
        Rectangle rec2 = new Rectangle(x, y, img_right.getWidth(null), img_right.getHeight(null));
        Rectangle rec3 = new Rectangle(x, y + 45 - img_up.getHeight(null), img_up.getWidth(null), img_up.getHeight(null));
        Rectangle rec4 = new Rectangle(x, y, img_down.getWidth(null), img_down.getHeight(null));
    ...
    public boolean isImpactBombExplodeVsActor(Actor actor) {
    ...
    private void setImage(int orient, int size) {
        switch (orient) {
            case Bomber.LEFT:
                if (size == 2) {
